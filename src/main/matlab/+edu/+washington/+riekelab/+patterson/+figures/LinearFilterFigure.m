    ...
    methods
        ...
        function handleEpoch(obj, epoch)
            ...
            if obj.epochCount >= obj.updatePattern(1) && tempPattern == 0
                ...
                frameTimes = edu.washington.riekelab.patterson.utils.getFrameTiming(FMdata,lightCrafterFlag);
                ...
                obj.newFilter = edu.washington.riekelab.patterson.utils.getLinearFilterOnline(obj.allStimuli,obj.allResponses,...
