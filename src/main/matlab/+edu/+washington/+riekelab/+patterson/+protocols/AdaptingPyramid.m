classdef AdaptingPyramid < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            colors = edu.washington.riekelab.patterson.utils.pmkmp(obj.numSteps, 'CubicL');
            ...
            if numel(obj.rig.getDeviceNames('Amp')) < 2
                ...
                obj.showFigure('edu.washington.riekelab.patterson.figures.MeanResponseFigure',...
                    obj.rig.getDevice(obj.amp), 'groupBy', {'stepAmplitude'},...
                    'recordingType', obj.onlineAnalysis, 'sweepColor', colors);
