classdef SquareGenerator < symphonyui.core.StimulusGenerator
    % Generates a squarewave stimulus with optional rectification.
    % Default rectification is false.
    %
    % The advantage over PulseTrainGenerator is similar specification 
    % parameters as Symphony's builtin SquareGenerator.
    %
    % SSP - 17Feb2019
    % ---------------------------------------------------------------------
    ...
    methods (Access = protected)
        ...
        function s = generateStimulus(obj)
            ...
            if obj.rectify
                square(square < obj.mean) = obj.mean; 
            end
